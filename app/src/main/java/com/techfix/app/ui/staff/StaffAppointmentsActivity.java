...
public class StaffAppointmentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        UiHelper.setupToolbar(this, "Repairs", true);
        ...
        String[] statuses = {"All", "PENDING", "ASSIGNED", "IN_PROGRESS", "COMPLETED", "CANCELLED"};
    ...
    private void load() {
        allItems = dao.getAllAppointments(null);
        filter();
    }
    ...
    private void filter() {
        ...
        for (Appointment a : allItems) {
            ...
            boolean matchesStatus = status.equals("All") || a.status.equalsIgnoreCase(status);
